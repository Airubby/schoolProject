package com.loncom.ismac.bean.tm;
...
public class DevheadXml1 {
	...
	private List<DevvouXml1> point = new ArrayList<DevvouXml1>();

	

	
	public List<DevvouXml1> getPoint() {
		return point;
	}

	public void setPoint(List<DevvouXml1> point) {
		this.point = point;
	}
