        ...
        <div class="loncom_right_content">
            <div class="bg1C2443 loncom_pd20 loncom_content">
                <div class="loncom_mb20 custom">
                    <el-select v-model="initParams.ROOMTYPE" placeholder="请选择" size="small" class="loncom_control_topc">
                    ...
                    <el-button type="primary" size="small" @click="set" class="loncom_fr">设置</el-button>
                </div>
